...
@NamedQueries({
    ...
    , @NamedQuery(name = "Ventas.findByActivos", query = "SELECT v FROM Ventas v WHERE v.status = 1")
    , @NamedQuery(name = "Ventas.findByBaja", query = "SELECT v FROM Ventas v WHERE v.status = 0")
