...
public class DetalleVentaController implements Serializable {
    ...
    private List<DetalleVenta> item2 = null;
    private DetalleVenta selected;

    public List<DetalleVenta> getItem2() {
        if (item2 == null) {
            //items = getFacade().findAll();
            item2 = ejbFacade.ListaBaja();
        }
        return item2;
    }

    public void setItem2(List<DetalleVenta> item2) {
        this.item2 = item2;
    }
    ...
    public void restaurar() {
        ...
        if (!JsfUtil.isValidationFailed()) {
            selected = null; // Remove selection
            items = null;    // Invalidate list of items to trigger re-query.
            item2 = null;    // Invalidate list of items to trigger re-query.
        }
    }
