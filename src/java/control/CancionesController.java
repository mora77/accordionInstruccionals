...
public class CancionesController implements Serializable {
    ...
    private List<Canciones> items2 = null;
    private Canciones selected;

    public List<Canciones> getItems2() {
        if (items2 == null) {
    ...
    public void setItems2(List<Canciones> items2) {
        this.items2 = items2;
    }
    ...
    public Canciones getCanciones(java.lang.Integer id) {
